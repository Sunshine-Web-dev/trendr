...
//before working well//require( ABSPATH . TRMINC . '/category.php' );
...
//before working well//require( ABSPATH . TRMINC . '/feed.php' );
...
//before working well////require( ABSPATH . TRMINC . '/canonical.php' );
