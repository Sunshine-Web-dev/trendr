...
jQuery(window).unload( function () { tinymce = tinyMCE = trmgallery = null; } ); // Cleanup

/* gallery settings */
var tinymce = null, tinyMCE, trmgallery;
...
trmgallery = {
	...
	setup : function() {
		...
		if ( t.el.nodeName != 'IMG' || ! ed.dom.hasClass(t.el, 'trmGallery') ) {
			if ( (g = ed.dom.select('img.trmGallery')) && g[0] ) {
				t.el = g[0];
			} else {
