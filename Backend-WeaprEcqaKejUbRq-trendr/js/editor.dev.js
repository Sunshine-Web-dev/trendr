...
jQuery(document).ready(function($){
	var h = trmCookies.getHash('TinyMCE_content_size');
...
var switchEditors = {
	...
	_trm_Nop : function(content) {
		...
		content = content.replace(/<trm_temp>/g, '\n');
	...
	go : function(id, mode) {
		...
		if ( 'tinymce' == mode ) {
			...
			ta.style.color = '#FFF';
			ta.value = this.trmautop(ta.value);
