...
function setUserSetting( name, value, del ) {
	...
	var c = 'trm-main-' + userSettings.uid, o = trmCookies.getHash(c) || {}, d = new Date(), p,
	...
	trmCookies.setHash(c, o, d, p);
	trmCookies.set('trm-main-time-'+userSettings.uid, userSettings.time, d, p);
...
function getAllUserSettings() {
	...
	return trmCookies.getHash('trm-main-' + userSettings.uid) || {};
}
