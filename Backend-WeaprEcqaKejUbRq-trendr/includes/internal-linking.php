 ...
 */
function trm_link_query( $args = array() ) {
 ...
 * @since 3.1.0
 */
function trm_link_dialog() {
?>
<form id="trm-link" tabindex="-1">
<?php trm_nonce_field( 'internal-linking', '_ajax_linking_nonce', false ); ?>
<div id="link-selector">
	...
	<?php $show_internal = '1' == get_user_setting( 'trmlink', '0' ); ?>
...
<div class="submitbox">
	<div id="trm-link-cancel">
		<a class="submitdelete deletion" href="#"><?php _e( 'Cancel' ); ?></a>
	</div>
	<div id="trm-link-update">
		<?php submit_button( __('Update'), 'primary', 'trm-link-submit', false, array('tabindex' => 100)); ?>
	</div>
</div>
</form>
<?php
