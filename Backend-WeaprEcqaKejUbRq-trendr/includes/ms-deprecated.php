<?php
/**
 * Deprecated multisite admin functions from past Trnder versions and Trnder MU.
 ...
 */
function trmmu_checkAvailableSpace() {
	_deprecated_function(__FUNCTION__, '3.0', 'is_upload_space_available()' );

	if ( !is_upload_space_available() )
		trm_die( __('Sorry, you must delete files before you can upload any more.') );
}
 ...
 */
function is_trmmu_sitewide_plugin( $file ) {
