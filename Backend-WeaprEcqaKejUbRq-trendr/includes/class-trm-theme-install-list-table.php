 ...
 * @access private
 */
class TRM_Theme_Install_List_Table extends TRM_List_Table {
	...
	function prepare_items() {
		include( ABSPATH . 'Backend-WeaprEcqaKejUbRq-trendr/includes/theme-install.php' );
		...
		if ( is_trm_error( $api ) )
			trm_die( $api->get_error_message() . '</p> <p><a href="#" onclick="document.location.reload(); return false;">' . __( 'Try again' ) . '</a>' );
