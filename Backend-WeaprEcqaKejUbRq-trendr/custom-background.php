...
class Custom_Background {
	...
	function admin_load() {
		...
		'<p>' . __( '<a href="http://codex.trendr.org/Appearance_Background_Screen" target="_blank">Documentation on Custom Background</a>' ) . '</p>' .
		'<p>' . __( '<a href="http://trendr.org/support/" target="_blank">Support Forums</a>' ) . '</p>' );
		trm_enqueue_script('custom-background');
	...
	function take_action() {
		...
		if ( isset($_POST['reset-background']) ) {
			check_admin_referer('custom-background-reset', '_key-custom-background-reset');
		...
		if ( isset($_POST['remove-background']) ) {
			...
			check_admin_referer('custom-background-remove', '_key-custom-background-remove');
...
<?php trm_nonce_field('custom-background-remove', '_key-custom-background-remove'); ?>
...
<td>
<form method="post" action="">
<?php trm_nonce_field('custom-background-reset', '_key-custom-background-reset'); ?>
...
<?php trm_nonce_field('custom-background-upload', '_key-custom-background-upload') ?>
...
<?php trm_nonce_field('custom-background'); ?>
...
<?php
	...
	function handle_upload() {
		...
		check_admin_referer('custom-background-upload', '_key-custom-background-upload');
		...
		update_post_meta( $id, '_trm_attachment_is_custom_background', get_option('stylesheet' ) );

		set_theme_mod('background_image', esc_url($url));

		$thumbnail = trm_get_attachment_image_src( $id, 'thumbnail' );
