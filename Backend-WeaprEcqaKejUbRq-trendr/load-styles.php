...
require(ABSPATH . '/Source-zACHAvU6As28quwr-trendr/script-loader.php');
...
trm_default_styles($trm_styles);

foreach( $load as $handle ) {
	if ( !array_key_exists($handle, $trm_styles->registered) )
		continue;

	$style = $trm_styles->registered[$handle];
