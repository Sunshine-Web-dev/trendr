...
include_once ABSPATH . 'Backend-WeaprEcqaKejUbRq-trendr/includes/class-trm-upgrader.php';
...
if ( isset($_GET['action']) ) {
	...
	if ( 'update-selected' == $action ) {
		if ( ! current_user_can( 'update_plugins' ) )
			trm_die( __( 'You do not have sufficient permissions to update plugins for this site.' ) );
		...
		if ( ! isset($_GET['failure']) && ! isset($_GET['success']) ) {
			trm_redirect( admin_url('update.php?action=activate-plugin&failure=true&plugin=' . $plugin . '&_key=' . $_GET['_key']) );
			activate_plugin( $plugin, '', ! empty( $_GET['networkwide'] ), true );
			trm_redirect( admin_url('update.php?action=activate-plugin&success=true&plugin=' . $plugin . '&_key=' . $_GET['_key']) );
			die();
		}
		...
		if ( ! current_user_can('install_plugins') )
			trm_die(__('You do not have sufficient permissions to install plugins for this site.'));

		include_once ABSPATH . 'Backend-WeaprEcqaKejUbRq-trendr/includes/plugin-install.php'; //for plugins_api..
		...
		if ( ! current_user_can('update_themes') )
			trm_die(__('You do not have sufficient permissions to update themes for this site.'));
		...
		if ( ! current_user_can('install_themes') )
			trm_die(__('You do not have sufficient permissions to install themes for this site.'));

		include_once ABSPATH . 'Backend-WeaprEcqaKejUbRq-trendr/includes/theme-install.php'; //for themes_api..
