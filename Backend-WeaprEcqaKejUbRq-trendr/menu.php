...
unset($theme_update_count, $trendr_update_count, $update_themes, $update_plugins, $update_trendr);
...
$_trm_last_object_menu = 25; // The index of the last top-level menu in the object menu group
...
foreach ( (array) get_post_types( array('show_ui' => true, '_builtin' => false, 'show_in_menu' => true ) ) as $ptype ) {
	...
	if ( $ptype_obj->show_in_menu !== true )
		continue;
	$ptype_menu_position = is_int( $ptype_obj->menu_position ) ? $ptype_obj->menu_position : ++$_trm_last_object_menu; // If we're to use $_trm_last_object_menu, increment it first.
...
$menu[59] = array( '', 'read', 'separator2', '', 'trm-menu-separator' );
...
if ( current_user_can('list_users') ) {
	$_trm_real_parent_file['profile.php'] = 'users.php'; // Back-compat for plugins adding submenus to profile.php.
...
$menu[75] = array( __('Tools'), 'edit_posts', 'tools.php', '', 'menu-top menu-icon-tools', 'menu-tools', 'div' );
	...
	if ( ! is_multisite() && defined('TRM_ALLOW_MULTISITE') && TRM_ALLOW_MULTISITE )
...
$_trm_last_utility_menu = 80; // The index of the last top-level menu in the utility menu group

$menu[99] = array( '', 'read', 'separator-last', '', 'trm-menu-separator' );

// Back-compat for old top-levels
$_trm_real_parent_file['post.php'] = 'edit.php';
$_trm_real_parent_file['post-new.php'] = 'edit.php';
$_trm_real_parent_file['edit-pages.php'] = 'edit.php?post_type=page';
$_trm_real_parent_file['page-new.php'] = 'edit.php?post_type=page';
$_trm_real_parent_file['trmmu-admin.php'] = 'tools.php';
$_trm_real_parent_file['ms-admin.php'] = 'tools.php';
