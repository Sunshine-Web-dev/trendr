...
function video_pause(){
    console.log("Tell them i am sick It is wonderful to kids");
    // console.log(document.getElementById('publish2'));
}
/*!
 * fullPage 3.0.5
...
(function( root, window, document, factory, undefined) {
    if( typeof define === 'function' && define.amd ) {
        ...
        define( function() {
            root.publish2 = factory(window, document);
            return root.publish2;
        } );
        ...
        // Browser globals.
        window.publish2 = factory(window, document);
    }
}(this, window, document, function(window, document){
    'use strict';

    // keeping central set of classnames and selectors
    var WRAPPER =               'publish2-wrapper';
    ...
    function initialise(containerSelector, options) {
        ...
        */
        ...
        if(container){
            ...
            window.publish2_api = FP;

            //using jQuery initialization? Creating the $.fn.publish2 object
            if(options.$){
                options.$.fn.publish2 = FP;
            }
        ...
        */
        ...
        /**
        * Works over the DOM structure to set it up for the current publish2 options.
        */
        function prepareDom(){
            css(container, {
                'height': '100%',
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            console.log("It is a wonderful time")
        ...
        */
        ...
        /**
        * Determines whether the focus is outside publish2.js sections/slides or not.
        */
        ...
        */
        ...
        /*
        * Destroys publish2.js plugin events and optinally its html markup and styles
        */
        ...
        /*
        * Removes inline styles added by publish2.js
        */
        function destroyStructure(){
            ...
            //removing the applied transition from the publish2 wrapper
            removeAnimation(container);
        ...
        function displayWarnings(){
            ...
            extensions.forEach(function(extension){
                ...
                if(options[extension]){
                    showError('warn', 'publish2.js extensions require publish2.extensions.min.js file instead of the usual publish2.js. Requested: '+ extension);
                }
            });
 ...
 */
if(window.jQuery && window.publish2){
    (function ($, publish2) {
        'use strict';

        // No jQuery No Go
        if (!$ || !publish2) {
            window.fp_utils.showError('error', 'jQuery is required to use the jQuery publish2 adapter!');
            return;
        }

        $.fn.publish2 = function(options) {
            options.$ = $;
            new publish2(this[0], options);
        };
    })(window.jQuery, window.publish2);
}
