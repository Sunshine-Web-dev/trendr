...
<li id="acomment-<?php trs_activity_comment_id(); ?>">
	<div class="acomment-portrait">
		<a href="<?php trs_activity_comment_user_link(); ?>">
			<?php trs_activity_portrait( 'type=thumb&user_id=' . trs_get_activity_comment_user_id() ); ?>
		</a>
	</div>
	...
	<div class="acomment-meta">
		...
		printf( __( '<a href="%1$s">%2$s</a> replied <a href="%3$s" class="activity-time-since"><span class="time-since">%4$s</span></a>', 'trendr' ), trs_get_activity_comment_user_link(), trs_get_activity_comment_name(), trs_get_activity_thread_permalink(), trs_get_activity_comment_date_recorded() );
		?>
	</div>
	...
	<div class="acomment-options">
		...
		<?php if ( is_user_logged_in() && trs_activity_can_comment_reply( trs_activity_current_comment() ) ) : ?>
			...
			<a href="#acomment-<?php trs_activity_comment_id(); ?>" class="acomment-reply trs-primary-action" id="acomment-reply-<?php trs_activity_id() ?>-from-<?php trs_activity_comment_id() ?>"><?php _e( 'Reply', 'trendr' ); ?></a>
