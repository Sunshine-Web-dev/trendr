<?php get_header( 'trendr' ) ?>
		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == trs_get_current_signup_step() ) : ?>
				...
				<?php do_action( 'trs_before_account_details_fields' ) ?>
							...
							<div class="account" id="details">

					<?php /***** Basic Account Details ******/ ?>

					<h4><?php _e( 'Sign up for a trendr account!', 'trnder' ) ?></h4>

					<?php do_action( 'trs_signup_username_errors' ) ?>
					<input type="text" placeholder="Username" name="signup_username"<?php _e( 'Username', 'trnder' ) ?> id="signup_username" value="<?php trs_signup_username_value() ?>" />

					<?php do_action( 'trs_signup_email_errors' ) ?>
					<input type="text" placeholder="Email Address" name="signup_email" id="signup_email" value="<?php trs_signup_email_value() ?>" />

					<?php do_action( 'trs_signup_password_errors' ) ?>
					<input type="password" placeholder="Choose a Password" name="signup_password" id="signup_password" value="" />

					<?php do_action( 'trs_signup_password_confirm_errors' ) ?>
					<input type="password" placeholder="Confirm Password" name="signup_password_confirm" id="signup_password_confirm" value="" />
				<div class="submit">
					<input type="submit" name="signup_submit" id="signup_submit" value="<?php _e( 'Sign Up', 'trnder' ) ?>" />
				</div>
				</div><!-- #details -->
	...
	</div><!-- #app -->		<img id="front-bottom" src="../../../../../../trm-src/858483/TRENDR/a/images/trendr-white-bg.png" style=""  >
