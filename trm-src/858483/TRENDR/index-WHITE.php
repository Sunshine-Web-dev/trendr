...
<?php get_header() ?>	<div ><img id="front-title"src="../../../../../../trm-src/858483/TRENDR/a/images/front-page-top20.png"    ></div>
...
<input type="text" placeholder="Username or E-mail" id="user-login" name="log" value="<?php echo isset( $_REQUEST['s'] ) ? esc_attr( $_REQUEST['s'] ) : ''; ?>" tabindex="97" />
			...
			<br />	
			<img id="front-middle" src="../../../../../../trm-src/858483/TRENDR/a/images/front-page-middle11.png" style=""  >	
			<img id="front-bottom" src="../../../../../../trm-src/858483/TRENDR/a/images/front-page-bottom18.png" style=""  >
