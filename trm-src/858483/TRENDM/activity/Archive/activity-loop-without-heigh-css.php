...
$("html #frame").contents().find(".trs-img embed").show();
     $("html #frame").contents().find(".dim").hide();
...
////f3.active
          ...
          $('html').on(' click touchstart','#f3.active',function(){
...
$('html').on('click ','#f4.openblah',function(){
