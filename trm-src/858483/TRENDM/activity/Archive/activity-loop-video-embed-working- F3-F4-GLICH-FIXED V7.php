...
$('html').on('  touchstart  scroll   touchmove touchend touchcancel touchleave touch','li#f1',function(){
...
$('html').on('  touchstart  scroll   touchmove touchend touchcancel touchleave touch','li#f2',function(){
...
$('html').on('  touchstart  scroll   touchmove touchend touchcancel touchleave touch','li#f3',function(){
    //  $(".dim").hide();
     $("iframe#blah ").stop();
        $("iframe#blah ").off();
...
$('.site-content ').hide();
      ...
      $("#l-c #frame ").contents().find('.container').show();
            $("#l-c #frame ").contents().find('.trs-img embed').show();
            $("#l-c #frame ").contents().find(".site-content").show();
...
$('html').on('  touchstart scroll touchmove touchend touchcancel touchleave touch','li#f4',function(){
    //  $(".dim").hide();
         $("iframe#blah ").stop();
