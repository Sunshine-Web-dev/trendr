...
$('html').on('click ','#f1.openblah',function(){
               $("iframe#blah ").stop();
...
$('#l-b ').on('click click scroll   touchmove touchend touchcancel touchleave touch','a ',function(){
...
$('html').on('click  ','li#f3',function(){
    ...
    //Hides F4 openblah on F3 // Removes lag
...
$('html').on('click  ','#f3.openblah',function(){
                 $("iframe#blah ").stop();

    //Hides F4 openblah on F3 // Removes lag
     $("#l-d iframe#frame").contents().find('iframe#blah').hide();
     $("#l-c iframe#frame").contents().find('iframe#blah').show();
...
////f3  -- line sensetive
// removal of #blah on nav2 navigation
          $('html').on('click  click','#f3.active.openblah',function(){
                           $("iframe#blah ").stop();
...
$('html').on('click  click scroll touchmove touchend touchcancel touchleave touch','li#f4',function(){

                            $("iframe#blah ").stop();

    //Hides F3 openblah on F4 // Removes lag
     $("#l-c iframe#frame").contents().find('iframe#blah').hide();
...
$('html').on(' click','#f4.openblah',function(){                 $("iframe#blah ").stop();

    //Hides F4 openblah on F3 // Removes lag
     $("#l-c iframe#frame").contents().find('iframe#blah').hide();
     $("#l-d iframe#frame").contents().find('iframe#blah').show();
