...
/***
 * AJAX Functions
 *	if ( !trs_is_activity_component(!empty( $_TRS_COOKIE['trs-' . $object . '-filter'] ) && '-1' != $_TRS_COOKIE['trs-' . $object . '-filter'] )) {
...
function trs_dtheme_new_activity_comment() {
	...
	if ( empty( $template ) )
		$template = TRS_PLUGIN_DIR . '/858583/TRENDR/activity/comment.php';
