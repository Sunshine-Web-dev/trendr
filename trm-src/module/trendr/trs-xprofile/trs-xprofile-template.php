...
function trs_portrait_upload_form() {
	...
	if ( !(int)$trs->site_options['trs-disable-portrait-uploads'] )
		trs_core_portrait_admin( null, $trs->loggedin_user->domain . $trs->profile->slug . '/change-profile-photo/', $trs->loggedin_user->domain . $trs->profile->slug . '/delete-portrait/' );
	else
...
function trs_portrait_delete_link() {
	...
	function trs_get_portrait_delete_link() {
		...
		return apply_filters( 'trs_get_portrait_delete_link', trm_nonce_url( $trs->displayed_user->domain . $trs->profile->slug . '/change-profile-photo/delete-portrait/', 'trs_delete_portrait_link' ) );
	}
