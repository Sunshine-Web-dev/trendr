 ...
 * Description: Social networking in a box. Build a social network for your company, school, sports team or niche community all based on the power and flexibility of trendr.
...
// Load the TRM abstraction file so Trnder can run on all Trnder setups.
require( TRS_PLUGIN_DIR . '/trs-core/trs-core-trmabstraction.php' );
$trs = new stdClass();
// Test to see whether this is a new installation or an upgraded version of Trnder
