...
return true;
	...
	jq('div.activity').click( function(event) {
		...
		if ( target.parent().hasClass('load-more') ) {
			jq("#skeleton li.load-more").addClass('loading');
			...
			function(response)
			{
				jq("#skeleton li.load-more").removeClass('loading');
				jq.cookie( 'trs-activity-oldestpage', oldest_page, {path: '/'} );
				jq("#skeleton ul.activity-list").append(response.contents);
