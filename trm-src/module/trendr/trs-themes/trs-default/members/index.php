	...
	<div id="skeleton">
		...
		<form action="" method="post" id="members-directory-form" class="dir-form">
			...
			<div class="contour-select" role="navigation">
				<ul>
					<li class="selected" id="members-all"><a href="<?php echo trailingslashit( trs_get_root_domain() . '/' . trs_get_members_root_slug() ); ?>"><?php printf( __( 'All Members <span>%s</span>', 'trendr' ), trs_get_total_member_count() ); ?></a></li>

					<?php if ( is_user_logged_in() && trs_is_active( 'friends' ) && trs_get_total_friend_count( trs_loggedin_user_id() ) ) : ?>

						<li id="members-personal"><a href="<?php echo trs_loggedin_user_domain() . trs_get_friends_slug() . '/my-friends/' ?>"><?php printf( __( 'My Friends <span>%s</span>', 'trendr' ), trs_get_total_friend_count( trs_loggedin_user_id() ) ); ?></a></li>
