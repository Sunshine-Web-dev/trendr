...
<form action="<?php trs_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">

	<?php do_action( 'trs_before_activity_post_form' ); ?>

	<div id="whats-new-portrait">
