		...
		<div class="dimension">
			...
			<div class="contour-select activity-type-tabs" role="navigation">
				<ul>
					...
					<li class="selected" id="activity-all"><a href="<?php echo trs_loggedin_user_domain() . trs_get_activity_slug() . '/'; ?>" title="<?php _e( 'The public activity for everyone on this site.', 'trendr' ); ?>"><?php printf( __( 'All Members <span>%s</span>', 'trendr' ), trs_get_total_site_member_count() ); ?></a></li>
					...
					<?php if ( is_user_logged_in() ) : ?>
						...
						<?php if ( trs_is_active( 'friends' ) ) : ?>
							...
							<?php if ( trs_get_total_friend_count( trs_loggedin_user_id() ) ) : ?>
								...
								<li id="activity-friends"><a href="<?php echo trs_loggedin_user_domain() . trs_get_activity_slug() . '/' . trs_get_friends_slug() . '/'; ?>" title="<?php _e( 'The activity of my friends only.', 'trendr' ); ?>"><?php printf( __( 'My Friends <span>%s</span>', 'trendr' ), trs_get_total_friend_count( trs_loggedin_user_id() ) ); ?></a></li>
				...
				<ul>
					...
					<li id="post-refine" class="last">
						...
						<select id="activity-filter-by">
							...
							<option value="geo_locate"><?php _e( 'geo locations', 'trendr' ); ?></option>
