...
<li id="acomment-<?php trs_activity_comment_id(); ?>">
	...
	<div class="acomment-meta">
		...
		printf( __( '<a href="%1$s">%2$s</a> replied <a href="%3$s" class="expand"><span class="time">%4$s</span></a>', 'trendr' ), trs_get_activity_comment_user_link(), trs_get_activity_comment_name(), trs_get_activity_thread_permalink(), trs_get_activity_comment_date_recorded() );
		?>
	</div>
