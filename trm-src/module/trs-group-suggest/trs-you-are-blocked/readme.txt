...
* This plugin only filters trendr features and pages. trendr related actions such as creating a new post or commenting is not blocked!
...
1. Upload `trendr-block` to the `/trm-content/module/` directory
