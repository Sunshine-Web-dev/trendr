...
Tested up to: TRM 3.9.x / TRS 2.0.x
Stable tag: 1.2.1

== Description ==

Follow members on your Trnder site with this nifty plugin.
...
* Brazilian Portuguese - [espellcaste](https://profiles.trendr.org/espellcaste)
* German - [solhuebner](https://profiles.trendr.org/solhuebner)
...
= 1.2 =
* Add Trnder 1.7 theme compatibility
