...
function trs_follow_init() {
	...
	// show admin notice for users on TRS 1.2.x
		...
		add_action( 'admin_notices', create_function( '', "
			echo '<div class=\"error\"><p>' . sprintf( __( \"Hey! TRS Follow v1.2 requires trendr 1.5 or higher.  If you are still using trendr 1.2 and you don't plan on upgrading, use <a href='%s'>TRS Follow v1.1.1 instead</a>.\", 'trs-follow' ), 'https://github.com/r-a-y/trendr-followers/archive/1.1.x.zip' ) . '</p></div>';
		" ) );
