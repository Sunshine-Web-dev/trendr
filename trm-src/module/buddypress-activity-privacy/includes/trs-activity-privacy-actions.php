...
add_action('trs_activity_privacy_options','trs_add_activitiy_visibility_selectbox');
...
add_action('trs_activity_entry_content1', 'trs_update_activitiy_visibility_selectbox',10);
