...
class QM_Component_DB_Queries extends QM_Component {
	...
	function process_db_object( $id, trmdb $db ) {
		...
		foreach ( (array) $db->queries as $query ) {
			...
			if ( false !== strpos( $query['stack'], 'trm_admin_bar' ) and !isset( $_REQUEST['qm_display_admin_bar'] ) )
				continue;
