...
Ensure this file is symlinked to your trm-content directory to provide
...
class QueryMonitorDB extends trmdb {
	...
	function query( $query ) {
		...
		if ( $this->last_error = mysql_error( $this->dbh ) ) {
			if ( defined( 'SAVEQUERIES' ) && SAVEQUERIES )
				$this->queries[$this->num_queries]['result'] = new TRM_Error( 'qmdb', $this->last_error );
...
$trmdb = new QueryMonitorDB( DB_USER, DB_PASSWORD, DB_NAME, DB_HOST );
