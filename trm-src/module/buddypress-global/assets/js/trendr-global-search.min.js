jQuery(document).ready(function(e) {
    ...
    e(document).on("click", ".bboss_search_results_wrapper .item-list-tabs li a", function(t) {
        t.preventDefault();
        _this = this;
    ...
    e(document).on("click", ".bboss_search_results_wrapper .pagination-links a", function(t) {
        ...
        var r = e(".bboss_search_results_wrapper .item-list-tabs li.active").data("item");
        n.subset = r;
