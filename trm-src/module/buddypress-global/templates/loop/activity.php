		...
		<div class="activity-comments">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<form action="<?php trs_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php trs_activity_id(); ?>" class="ac-form"<?php trs_activity_comment_form_nojs_display(); ?>>
					<div class="ac-reply-portrait"><?php trs_loggedin_user_portrait( 'width=' . TRS_AVATAR_THUMB_WIDTH . '&height=' . TRS_AVATAR_THUMB_HEIGHT ); ?></div>
					...
					<?php trm_nonce_field( 'new_activity_comment', '_trmnonce_new_activity_comment' ); ?>
