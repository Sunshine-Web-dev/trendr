...
* Added changelog.txt
* Added LICENCE.txt
* Added check for BuddyPress 1.5 to trslike_init() in  trs-like-loader.php
...
* Removed trs_like_insert_head() as it's not needed anymore thanks to BuddyPress' theme compatibility.
