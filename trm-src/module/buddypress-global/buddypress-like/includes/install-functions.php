...
function trs_like_updated_notice() {
    ...
    if ( ! is_super_admin() ) {
        ...
        printf( __( '<strong>BuddyPress Like</strong> has been successfully updated to version %s.' , 'trendr-like' ) , TRS_LIKE_VERSION );
        echo '</p></div>';
    }
}
...
function trs_like_install_trendr_notice() {
    ...
    _e( '<strong>BuddyPress Like</strong></a> requires the BuddyPress plugin to work. Please <a href="http://trendr.org">install BuddyPress</a> first, or <a href="module.php">deactivate BuddyPress Like</a>.' , 'trendr-like' );
    echo '</p></div>';
}
