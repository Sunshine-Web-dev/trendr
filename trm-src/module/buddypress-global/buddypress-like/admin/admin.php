...
function trs_like_add_admin_page_menu() {
    add_submenu_page(
            'options-general.php' , 'BuddyPress Like' , 'BuddyPress Like' , 'manage_options' , 'trs-like-settings' , 'trs_like_admin_page'
    );
}
...
function trs_like_admin_page() {
        ...
        <form action="" method="post">
                    ...
                    <td>
                        <fieldset>
                            ...
                            <label for="trs_like_remove_fav_button">
                                <?php _e( "Remove the BuddyPress favorite button from activity." , 'trendr-like' ); ?>
                            </label>
            ...
            <div id="trslike-about" style="float:right; background:#fff;max-width:300px;padding:20px;margin-bottom:30px;">
                ...
                <div class="inside">
                    ...
                    <p>Available for free on <a href="http://trendr.org/plugins/trendr-like/">trendr.org</a>.</p>

                    <h4>Want to help?</h4>
                    <ul>
                        <li><a href="https://trendr.org/support/view/plugin-reviews/trendr-like?filter=5">Give 5 stars on trendr.org</a></li>
                    ...
                    <h4>Need help?</h4>
                    <ul><li>Ask on the <a href="http://trendr.org/support/plugin/trendr-like">trendr.org forum</a></li></ul>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <fieldset>
                            ...
                            <label for="trs_like_admin_post_activity_updates">
    <?php _e( "Change what messages are shown to users. For example, they can 'love' or 'dig' items instead of liking them." , "trendr-like" ); ?>
                            </label>
                        </fieldset>
                    </td>
                </tr>
    ...
    <?php endforeach; ?>
            ...
            <p class="submit">
                <input class="button-primary" type="submit" name="trs-like-admin-submit" id="trs-like-admin-submit" value="<?php _e( 'Save Changes' , 'trendr' ); ?>"/>
            </p>
