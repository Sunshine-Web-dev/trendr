...
if (!class_exists('BuddyBoss_Global_Search_Plugin')):
	...
	class BuddyBoss_Global_Search_Plugin {
		 ...
		 * module from tampering with essential information indirectly, which
		...
		public function setup_textdomain() {
			...
			//first try to load from trm-srcs/languages/module/ directory
			load_textdomain($domain, TRM_LANG_DIR . '/module/' . $domain . '-' . $locale . '.mo');
		 ...
		 * to the 'trs_loaded' action which BuddyPress calls after it's started
		...
		public function assets(){
			...
			trm_enqueue_script( 'jquery-ui-autocomplete' );
			...
			trm_enqueue_script( 'trendr-global-search', $this->assets_url . '/js/trendr-global-search.min.js', array( 'jquery', 'jquery-ui-autocomplete' ), '1.0.0' );
