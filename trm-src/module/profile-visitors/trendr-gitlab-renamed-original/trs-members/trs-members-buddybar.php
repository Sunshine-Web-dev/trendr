...
function trs_adminbar_notifications_menu() {
	...
	echo '<li id="trs-adminbar-notifications-menu"><a href="' . $trs->loggedin_user->domain . '">';
	_e( 'Notifications', 'trendr' );
	...
	if ( $notifications ) {
		...
		<li><a href="<?php echo $trs->loggedin_user->domain ?>"><?php _e( 'No new notifications.', 'trendr' ); ?></a></li>
...
function trs_members_adminbar_admin_menu() {
	...
	<li id="trs-adminbar-adminoptions-menu">
		...
		<ul>
			...
			<li><a href="<?php trs_members_component_link( 'profile', 'change-portrait' ); ?>"><?php printf( __( "Edit %s's Avatar", 'trendr' ), esc_attr( $trs->displayed_user->fullname ) ) ?></a></li>
