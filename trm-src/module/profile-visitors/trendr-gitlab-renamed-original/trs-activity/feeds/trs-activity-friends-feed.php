...
<rss version="2.0"
	...
	<?php do_action('trs_activity_friends_feed'); ?>
>

<channel>
	<title><?php trs_site_name() ?> | <?php trs_displayed_user_fullname(); ?> | <?php _e( 'Friends Activity', 'trendr' ); ?></title>
	<atom:link href="<?php self_link(); ?>" rel="self" type="application/rss+xml" />
	<link><?php echo trs_displayed_user_domain() . trs_get_activity_slug() . '/' . trs_get_friends_slug() . '/feed'; ?></link>
	<description><?php printf( __( '%s - Friends Activity Feed', 'trendr' ), trs_get_displayed_user_fullname() ); ?></description>
	...
	<?php do_action('trs_activity_friends_feed_head'); ?>

	<?php if ( trs_has_activities( 'scope=friends&max=50&display_comments=stream' ) ) : ?>
