			...
			<table class="form-table">
				<tbody>
					...
					<?php if ( trs_is_active( 'xprofile' ) ) : ?>
						...
						<tr>
							<th scope="row"><?php _e( 'Disable trendr to WordPress profile syncing?', 'trendr' ) ?></th>
							<td>
...
function trs_core_admin_page_options() {
	...
	<p><?php _e( 'Associate a WordPress Page with each trendr component directory.', 'trendr' ); ?></p>
	...
	<p><?php _e( 'Associate WordPress Pages with the following trendr Registration pages.', 'trendr' ); ?></p>
