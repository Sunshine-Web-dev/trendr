...
// Save any posted values
	...
	function step_ms_update() {
		...
		<p><?php printf( __( 'trendr has detected a recent change to trendr Multisite, which allows members of your community to have their own trendr sites. You can enable or disable this feature at any time at <a href="%s">Network Options</a>.', 'trendr' ), network_admin_url( 'settings.php' ) ); ?></p>

		<p><?php __( "Please select the trendr page you would like to use to display the site directory. You can either choose an existing page or let trendr auto-create a page for you. If you'd like, you can go to manually create pages now, and return to this step when you are finished.", 'trendr' ) ?></p>
		...
		<table class="form-table">
			...
			<tr valign="top" id="site-tracking-page-selector">
				<th scope="row"><?php _e( 'Select a trendr page for the Sites directory.', 'trendr' ); ?></th>
	...
	function step_pages() {
		...
		<p><?php _e( 'trendr now uses trendr pages to display content. This allows you to easily change the names of pages or move them to a sub page.', 'trendr' ); ?></p>
		...
		<table class="form-table">
			<tr>
				<th>
					...
					<img src="<?php echo plugins_url( '/trendr/trs-858583/trs-default/screenshot.png' ); ?>" alt="<?php _e( 'trendr Default', 'trendr' ); ?>" />
				</th>
				<td>
					...
					<p><strong><?php _e( 'This is the best choice if you do not have an existing trendr theme, or want to start using trendr immediately.', 'trendr' ); ?></strong></p>
			...
			<tr>
				...
				<td>
					<p><?php _e( 'The trendr Template Pack plugin will guide you through the process of manually upgrading your existing trendr theme. This usually involves following the step-by-step instructions and copying the trendr template files into your theme. This option requires a working knowledge of CSS and HTML, as you will need to tweak the new templates to match your existing theme.', 'trendr' ); ?></p>
					...
					<div id="message" class="updated fade"><p>
						...
						<?php
							...
							if ( !empty( $iis7_permalinks ) ) {
								...
								_e( 'If your <code>.htaccess</code> file were <a href="http://codex.trendr.org/Changing_File_Permissions">writable</a>, we could do this automatically, but it isn&#8217;t so these are the mod_rewrite rules you should have in your <code>.htaccess</code> file. Click in the field and press <kbd>CTRL + a</kbd> to select all.' ); ?>
						...
						<?php
							if ( empty( $iis7_permalinks ) )
								_e( 'Paste all these rules into a new <code>.htaccess</code> file in the root of your trendr installation and save the file. Once you\'re done, please hit the "Save and Next" button to continue.', 'trendr' );
						?>
