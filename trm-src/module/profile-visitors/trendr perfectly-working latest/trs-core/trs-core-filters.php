 ...
 *
 * Sets the "From" name in emails sent to the name of the site and not "trendr"
 *
 * @package trendr Core
 ...
 * @param string $welcome_email Complete email passed through trendr
...
function trs_core_activation_signup_blog_notification( $domain, $path, $title, $user, $user_email, $key, $meta ) {
	...
	$from_name       = ( '' == get_site_option( 'site_name' ) ) ? 'trendr' : esc_html( get_site_option( 'site_name' ) );
