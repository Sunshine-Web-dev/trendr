...
// var_dump($r);
	...
	if($r['scope'] == False && isset($GLOBALS['scopes'])){
	 ...
	 // If you have passed a "scope" then this will override any filters you have passed.
			if ( 'just-me' == $scope ||'recommend' == $scope||'following' == $scope|| 'friends' == $scope || 'groups' == $scope || 'favorites' == $scope || 'mentions' == $scope ) {
				if ( 'just-me' == $scope )
		...
		//						$user_id = 0;
						...
						//	$user_id = 0;
							...
							if(class_exists('BuddypressRecommended')){


							 $buddy = new BuddypressRecommended();
