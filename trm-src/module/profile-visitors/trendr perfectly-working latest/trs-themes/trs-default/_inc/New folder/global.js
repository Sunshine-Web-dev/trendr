...
function trs_init_activity() {
	...
	if ( null != jq.cookie('trs-activity-filter') && jq('#activity-filter-select').length )
		jq('#activity-filter-select select option[value="' + jq.cookie('trs-activity-filter') + '"]').prop( 'selected', true );
