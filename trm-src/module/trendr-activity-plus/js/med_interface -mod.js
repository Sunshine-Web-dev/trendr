...
var $textContainer;
var orgEvents ;
var initcallbaks = function(){
	 $('#med_cancel').click(function () {
...
var MedVideoHandler = function () {
	...
	var createMarkup = function () {
		...
		$(window).unbind("resize.med").bind("resize.med", resize);
		resize();
...
var MedPhotoHandler = function () {
	...
	var createMarkup = function () {
		...
		$("#med_remote_image_container .med_remote_image").change( createRemoteImagePreview);
