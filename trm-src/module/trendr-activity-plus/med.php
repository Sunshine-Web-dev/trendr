<?php
/*
Plugin Name: trendr Activity Plus
...
if (is_multisite() && defined('TRMMU_PLUGIN_URL') && defined('TRMMU_PLUGIN_DIR') && file_exists(TRMMU_PLUGIN_DIR . '/' . basename(__FILE__))) {
	define ('MED_PLUGIN_LOCATION', 'mu-plugins');
	define ('MED_PLUGIN_BASE_DIR', TRMMU_PLUGIN_DIR);
	define ('MED_PLUGIN_URL', str_replace('http://', MED_PROTOCOL, TRMMU_PLUGIN_URL));
	$textdomain_handler = 'load_muplugin_textdomain';
} else if (defined('TRM_PLUGIN_URL') && defined('TRM_PLUGIN_DIR') && file_exists(TRM_PLUGIN_DIR . '/' . MED_PLUGIN_SELF_DIRNAME . '/' . basename(__FILE__))) {
	...
	trm_die(__('There was an issue determining where trendr Activity Plus plugin is installed. Please reinstall.'));
}
