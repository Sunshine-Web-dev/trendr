...
function trs_like_process_ajax() {
    ...
    if ( $_POST['type'] == 'acomment-reply trs-primary-action like' ) {
        trs_like_add_user_like( $id , 'activity' );
    }

    if ( $_POST['type'] == 'acomment-reply trs-primary-action unlike' ) {
        trs_like_remove_user_like( $id , 'activity' );
    }
    ...
    if ( $_POST['type'] == 'acomment-reply trs-primary-action view-likes' ) {
        trs_like_get_likes( $id , 'activity' );
    }
