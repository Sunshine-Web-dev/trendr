<?php
/**
 * trendr Like - Activty Comment Button
 *
 * This function is used to display the trendr Like button on comments in the activity stream
 *
 * @package trendr Like
 *
 */
...
function trslike_activity_comment_button() {
    ...
    if ( is_user_logged_in() ) {
        ...
        if ( ! trs_like_is_liked( trs_get_activity_comment_id(), 'activity_comment', get_current_user_id() ) ) {
            ?>
            <a href="#" class="acomment-reply trs-primary-action like" id="like-activity-<?php echo trs_get_activity_comment_id(); ?>" title="<?php echo trs_like_get_text( 'like_this_item' ); ?>"><?php
               echo trs_like_get_text( 'like' );
                ...
                ?></a>
        <?php } else { ?>
            <a href="#" class="acomment-reply trs-primary-action unlike" id="unlike-activity-<?php echo trs_get_activity_comment_id(); ?>" title="<?php echo trs_like_get_text( 'unlike_this_item' ); ?>"><?php
