...
$output = '<div><ul>';
    foreach( $users_who_like as $user ) {
      ...
      $output .= '<li><a href="'. trs_core_get_userlink( $user, false, true ) .'">'. trs_core_fetch_portrait( array( 'item_id' => $user, 'object' => 'user', 'type' => 'thumb', 'class' => 'portrait reshared', 'width' => '40', 'height' => '40' ) ) .'</a></li>';
