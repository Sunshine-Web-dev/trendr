...
function trm_default_scripts( &$scripts ) {
	...
	$scripts->add( 'jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js','','1.7.1', true);
...
add_action( 'trm_default_scripts', 'trm_default_scripts', $in_footer );
