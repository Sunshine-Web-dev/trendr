...
<?php else : // This comment is in reply to another comment
	...
	// The rel attribute below and the id tag above should be GUIDs, but TRM doesn't create them for comments (unlike posts). Either way, its more important that they both use the same system
?>
