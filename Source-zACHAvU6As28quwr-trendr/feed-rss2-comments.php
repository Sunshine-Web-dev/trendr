...
<rss version="2.0"
	...
	xmlns:sy="http://purl.org/rss/1.0/858483s/syndication/"
...
<channel>
	<title><?php
		...
		elseif ( is_search() )
			printf(ent2ncr(__('Comments for %s searching on %s')), get_bloginfo_rss( 'name' ), esc_attr($trm_query->query_vars['s']));
		else
			printf(ent2ncr(__('Comments for %s')), get_bloginfo_rss( 'name' ) . get_trm_title_rss());
	?></title>
