<?php
/**
 * Trnder scripts and styles default loader.
 *
 * Most of the functionality that existed here was moved to
 * {@link http://backpress.automattic.com/ BackPress}. Trnder themes and
...
function trm_default_scripts( &$scripts ) {
	...
	$scripts->add( 'jquery', '/Source-zACHAvU6As28quwr-trendr/js/jquery/jquery.js', false, '1.10.2');

	$scripts->add( 'jquery-ui-core', '/Source-zACHAvU6As28quwr-trendr/js/jquery/ui.core.js', array('jquery'), '1.8.12' );
	...
	$scripts->add( 'swfupload-swfobject', '/Source-zACHAvU6As28quwr-trendr/js/swfupload/module/swfupload.swfobject.js', array('swfupload', 'swfobject'), '2201a');
	$scripts->add( 'swfupload-queue', '/Source-zACHAvU6As28quwr-trendr/js/swfupload/module/swfupload.queue.js', array('swfupload'), '2201');
	$scripts->add( 'swfupload-speed', '/Source-zACHAvU6As28quwr-trendr/js/swfupload/module/swfupload.speed.js', array('swfupload'), '2201');
	...
	$scripts->add( 'trmlink', "/Source-zACHAvU6As28quwr-trendr/js/tinymce/module/trmlink/js/trmlink$suffix.js", array( 'jquery', 'trmdialogs' ), '20110528' );
	...
	$scripts->add( 'trmdialogs', "/Source-zACHAvU6As28quwr-trendr/js/tinymce/module/trmdialogs/js/trmdialog$suffix.js", array( 'jquery-ui-dialog' ), '20110528' );
	$scripts->add_data( 'trmdialogs', 'group', 1 );

	$scripts->add( 'trmdialogs-popup', "/Source-zACHAvU6As28quwr-trendr/js/tinymce/module/trmdialogs/js/popup$suffix.js", array( 'trmdialogs' ), '20110421' );
...
function trm_default_styles( &$styles ) {
	...
	$styles->add( 'trmlink', "/Source-zACHAvU6As28quwr-trendr/js/tinymce/module/trmlink/css/trmlink$suffix.css", array(), '20101224' );
