<?php
/**
 * Deprecated functions from past Trnder versions. You shouldn't use these
...
/**
 * Sets up the Trnder Loop.
 *
 * @since 1.0.1
 * @deprecated 1.5
 * @deprecated Use The Loop - {@link http://codex./The_Loop Use new Trnder Loop}
 */
function start_trm() {
	global $trm_query, $post;

	_deprecated_function( __FUNCTION__, '1.5', __('new Trnder Loop') );
 ...
 * @since 1.0.1
 * @deprecated 2.1
 * @deprecated Use trm_list_bookmarks()
 * @see trm_list_bookmarks()
 *
 * @param string $category The category to use.
 * @param string $args
 * @return bool|null
 */
function trm_get_linksbyname($category, $args = '') {
	_deprecated_function(__FUNCTION__, '2.1', 'trm_list_bookmarks()');
 ...
 * @since 0.71
 * @deprecated 2.1
 * @deprecated Use trm_list_categories()
 * @see trm_list_categories()
 *
 * @param int $optionall
 * @param string $all
...
function list_cats($optionall = 1, $all = 'All', $sort_column = 'ID', $sort_order = 'asc', $file = '', $list = true, $optiondates = 0,
	...
	_deprecated_function( __FUNCTION__, '2.1', 'trm_list_categories()' );

	$query = compact('optionall', 'all', 'sort_column', 'sort_order', 'file', 'list', 'optiondates', 'optioncount', 'hide_empty', 'use_desc_for_title', 'children',
		'child_of', 'categories', 'recurse', 'feed', 'feed_image', 'exclude', 'hierarchical');
	return trm_list_cats($query);
}
 ...
 * @return unknown
 */
function trm_list_cats($args = '') {
	_deprecated_function( __FUNCTION__, '2.1', 'trm_list_categories()' );

	$r = trm_parse_args( $args );
	...
	return trm_list_categories($r);
}

/**
 * @since 0.71
 * @deprecated 2.1
 * @deprecated Use trm_dropdown_categories()
 * @see trm_dropdown_categories()
 *
 * @param int $optionall
 * @param string $all
...
function dropdown_cats($optionall = 1, $all = 'All', $orderby = 'ID', $order = 'asc',
	...
	_deprecated_function( __FUNCTION__, '2.1', 'trm_dropdown_categories()' );
	...
	return trm_dropdown_categories($query);
}

/**
 * @since 1.2
 * @deprecated 2.1
 * @deprecated Use trm_list_authors()
 * @see trm_list_authors()
 *
...
function list_authors($optioncount = false, $exclude_admin = true, $show_fullname = false, $hide_empty = true, $feed = '', $feed_image = '') {
	_deprecated_function( __FUNCTION__, '2.1', 'trm_list_authors()' );

	$args = compact('optioncount', 'exclude_admin', 'show_fullname', 'hide_empty', 'feed', 'feed_image');
	return trm_list_authors($args);
}

/**
 * @since 1.0.1
 * @deprecated 2.1
 * @deprecated Use trm_get_post_categories()
 * @see trm_get_post_categories()
 *
 * @param int $blogid Not Used
 * @param int $post_ID
 * @return unknown
 */
function trm_get_post_cats($blogid = '1', $post_ID = 0) {
	_deprecated_function( __FUNCTION__, '2.1', 'trm_get_post_categories()' );
	return trm_get_post_categories($post_ID);
}
 ...
 * @since 1.0.1
 * @deprecated 2.1
 * @deprecated Use trm_set_post_categories()
 * @see trm_set_post_categories()
 *
 * @param int $blogid Not used
 * @param int $post_ID
 ...
 * @return unknown
 */
function trm_set_post_cats($blogid = '1', $post_ID = 0, $post_categories = array()) {
	_deprecated_function( __FUNCTION__, '2.1', 'trm_set_post_categories()' );
	return trm_set_post_categories($post_ID, $post_categories);
}

/**
 * @since 0.71
 * @deprecated 2.1
 * @deprecated Use trm_get_archives()
 * @see trm_get_archives()
 *
 * @param string $type
 * @param string $limit
 * @param string $format
...
function get_archives($type='', $limit='', $format='html', $before = '', $after = '', $show_post_count = false) {
	_deprecated_function( __FUNCTION__, '2.1', 'trm_get_archives()' );
	$args = compact('type', 'limit', 'format', 'before', 'after', 'show_post_count');
	return trm_get_archives($args);
}
...
function link_pages($before='<br />', $after='<br />', $next_or_number='number', $nextpagelink='next page', $previouspagelink='previous page',
					$pagelink='%', $more_file='') {
	_deprecated_function( __FUNCTION__, '2.1', 'trm_link_pages()' );

	$args = compact('before', 'after', 'next_or_number', 'nextpagelink', 'previouspagelink', 'pagelink', 'more_file');
	return trm_link_pages($args);
}
 ...
 * $trmdb->linkcategories and output it as a nested HTML unordered list.
 *
 * @since 1.0.1
 * @deprecated 2.1
 * @deprecated Use trm_list_bookmarks()
...
function links_popup_script($text = 'Links', $width=400, $height=400, $file='links.all.php', $count = true) {
	...
	if ( $count )
		$counts = $trmdb->get_var("SELECT COUNT(*) FROM $trmdb->links");
...
/**
 * An alias of trm_create_user().
 *
 * @since 2.0
 * @deprecated 2.0
 * @deprecated Use trm_create_user()
 * @see trm_create_user()
 *
...
function create_user($username, $password, $email) {
	_deprecated_function( __FUNCTION__, '2.0', 'trm_create_user()' );
	return trm_create_user($username, $password, $email);
}
 ...
 * @since 1.0.0
 * @deprecated 3.0.0
 * @deprecated Use trm_load_alloptions())
 * @see trm_load_alloptions()
 *
 * @return array List of all options.
 */
function get_alloptions() {
	_deprecated_function( __FUNCTION__, '3.0', 'trm_load_alloptions()' );
	return trm_load_alloptions();
}
 ...
 * @since 2.0.0
 * @deprecated 2.5.0
 * @deprecated Use trm_get_attachment_link()
 * @see trm_get_attachment_link()
 *
...
function get_the_attachment_link($id = 0, $fullsize = false, $max_dims = false, $permalink = false) {
	_deprecated_function( __FUNCTION__, '2.5', 'trm_get_attachment_link()' );
	$id = (int) $id;
	$_post = get_post($id);

	if ( ('attachment' != $_post->post_type) || !$url = trm_get_attachment_url($_post->ID) )
 ...
 * @since 2.1.0
 * @deprecated 2.5.0
 * @deprecated Use trm_get_attachment_image_src()
 * @see trm_get_attachment_image_src()
 *
 * @param int $id Optional. Post ID.
...
function get_attachment_icon_src( $id = 0, $fullsize = false ) {
	_deprecated_function( __FUNCTION__, '2.5', 'trm_get_attachment_image_src()' );
	$id = (int) $id;
	if ( !$post = get_post($id) )
		return false;
	...
	if ( !$fullsize && $src = trm_get_attachment_thumb_url( $post->ID ) ) {
		// We have a thumbnail desired, specified and existing

		$src_file = basename($src);
		$class = 'attachmentthumb';
	} elseif ( trm_attachment_is_image( $post->ID ) ) {
		// We have an image without a thumbnail

		$src = trm_get_attachment_url( $post->ID );
		$src_file = $file;
		$class = 'attachmentimage';
	} elseif ( $src = trm_mime_type_icon( $post->ID ) ) {
 ...
 * @since 2.0.0
 * @deprecated 2.5.0
 * @deprecated Use trm_get_attachment_image()
 * @see trm_get_attachment_image()
 *
 * @param int $id Optional. Post ID.
...
function get_attachment_icon( $id = 0, $fullsize = false, $max_dims = false ) {
	_deprecated_function( __FUNCTION__, '2.5', 'trm_get_attachment_image()' );
	$id = (int) $id;
	if ( !$post = get_post($id) )
		return false;
 ...
 * @see esc_html()
 */
function trm_specialchars( $string, $quote_style = ENT_NOQUOTES, $charset = false, $double_encode = false ) {
	...
	if ( func_num_args() > 1 ) { // Maintain backwards compat for people passing additional args
		$args = func_get_args();
		return call_user_func_array( '_trm_specialchars', $args );
	} else {
 ...
 *
 * Passes to {@link trm_register_sidebar_widget()} after argument list and
 * backwards compatibility is complete.
 *
 * @since 2.2.0
 * @deprecated 2.8.0
 * @deprecated Use trm_register_sidebar_widget()
 * @see trm_register_sidebar_widget()
 *
...
function register_sidebar_widget($name, $output_callback, $classname = '') {
	_deprecated_function( __FUNCTION__, '2.8', 'trm_register_sidebar_widget()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
	...
	call_user_func_array('trm_register_sidebar_widget', $args);
}

/**
 * Alias of {@link trm_unregister_sidebar_widget()}.
 *
 * @since 2.2.0
 * @deprecated 2.8.0
 * @deprecated Use trm_unregister_sidebar_widget()
 * @see trm_unregister_sidebar_widget()
 *
 * @param int|string $id Widget ID.
 */
function unregister_sidebar_widget($id) {
	_deprecated_function( __FUNCTION__, '2.8', 'trm_unregister_sidebar_widget()' );
	return trm_unregister_sidebar_widget($id);
}
 ...
 * the array for the name.
 *
 * Passes to {@link trm_register_widget_control()} after the argument list has
 * been compiled.
 *
 * @since 2.2.0
 * @deprecated 2.8.0
 * @deprecated Use trm_register_widget_control()
 * @see trm_register_widget_control()
 *
...
function register_widget_control($name, $control_callback, $width = '', $height = '') {
	_deprecated_function( __FUNCTION__, '2.8', 'trm_register_widget_control()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
			$name = sprintf($name[0], $name[2]);
	...
	call_user_func_array('trm_register_widget_control', $args);
}

/**
 * Alias of {@link trm_unregister_widget_control()}.
 *
 * @since 2.2.0
 * @deprecated 2.8.0
 * @deprecated Use trm_unregister_widget_control()
 * @see trm_unregister_widget_control()
 *
 * @param int|string $id Widget ID.
 */
function unregister_widget_control($id) {
	_deprecated_function( __FUNCTION__, '2.8', 'trm_unregister_widget_control()' );
	return trm_unregister_widget_control($id);
}
...
function delete_usermeta( $user_id, $meta_key, $meta_value = '' ) {
	...
	$cur = $trmdb->get_row( $trmdb->prepare("SELECT * FROM $trmdb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );

	if ( $cur && $cur->umeta_id )
		do_action( 'delete_usermeta', $cur->umeta_id, $user_id, $meta_key, $meta_value );

	if ( ! empty($meta_value) )
		$trmdb->query( $trmdb->prepare("DELETE FROM $trmdb->usermeta WHERE user_id = %d AND meta_key = %s AND meta_value = %s", $user_id, $meta_key, $meta_value) );
	else
		$trmdb->query( $trmdb->prepare("DELETE FROM $trmdb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );

	clean_user_cache( $user_id );
	trm_cache_delete( $user_id, 'user_meta' );
...
function get_usermeta( $user_id, $meta_key = '' ) {
	...
	if ( !empty($meta_key) ) {
		...
		if ( false !== $user && isset($user->$meta_key) )
			...
			$metas = $trmdb->get_col( $trmdb->prepare("SELECT meta_value FROM $trmdb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );
	} else {
		$metas = $trmdb->get_col( $trmdb->prepare("SELECT meta_value FROM $trmdb->usermeta WHERE user_id = %d", $user_id) );
	}
...
function update_usermeta( $user_id, $meta_key, $meta_value ) {
	...
	if ( !$cur )
		$trmdb->insert($trmdb->usermeta, compact('user_id', 'meta_key', 'meta_value') );
	else if ( $cur->meta_value != $meta_value )
		$trmdb->update($trmdb->usermeta, compact('meta_value'), compact('user_id', 'meta_key') );
	else
		return false;
	...
	if ( !$cur )
		do_action( 'added_usermeta', $trmdb->insert_id, $user_id, $meta_key, $meta_value );
	else
...
function get_users_of_blog( $id = '' ) {
	...
	global $trmdb, $blog_id;
	if ( empty($id) )
		$id = (int) $blog_id;
	$blog_prefix = $trmdb->get_blog_prefix($id);
	$users = $trmdb->get_results( "SELECT user_id, user_id AS ID, user_login, display_name, user_email, meta_value FROM $trmdb->users, $trmdb->usermeta WHERE {$trmdb->users}.ID = {$trmdb->usermeta}.user_id AND meta_key = '{$blog_prefix}capabilities' ORDER BY {$trmdb->usermeta}.user_id" );
	return $users;
}
...
function automatic_feed_links( $add = true ) {
	...
	if ( $add )
		...
		remove_action( 'trm_head', 'feed_links_extra', 3 ); // Just do this yourself in 3.0+
}
 ...
 * @return bool
 */
function trm_timezone_supported() {
