 ...
 * HTML.
 *
 * This function is used internally by trm_list_bookmarks() and should not be
 * used by themes.
 *
 ...
 * @link http://codex./Template_Tags/trm_list_bookmarks
 *
 * @since 2.1.0
 ...
 */
function trm_list_bookmarks($args = '') {
	$defaults = array(
	...
	$output = apply_filters( 'trm_list_bookmarks', $output );
