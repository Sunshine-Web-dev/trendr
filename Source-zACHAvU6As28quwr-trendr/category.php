 ...
 *
 * @since 2.0.0
 * @link http://codex./Function_Reference/get_all_category_ids
 *
 * @return object List of all of the category IDs.
 */
function get_all_category_ids() {
	if ( ! $cat_ids = trm_cache_get( 'all_category_ids', 'category' ) ) {
		$cat_ids = get_terms( 'category', array('fields' => 'ids', 'get' => 'all') );
		trm_cache_add( 'all_category_ids', $cat_ids, 'category' );
	}
 ...
 * @link http://codex./Function_Reference/get_categories
 *
 ...
 *
 * It is also possible that it will return a TRM_Error object on failure. Check
...
function get_cat_name( $cat_id ) {
	...
	if ( ! $category || is_trm_error( $category ) )
		return '';
