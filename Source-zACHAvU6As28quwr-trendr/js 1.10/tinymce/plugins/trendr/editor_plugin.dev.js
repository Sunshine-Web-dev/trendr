...
(function() {
	...
	tinymce.create('tinymce.plugins.trendr', {
		...
		init : function(ed, url) {
			var t = this, tbId = ed.getParam('trendr_adv_toolbar', 'toolbar2'), last = 0, moreHTML, nextpageHTML;
			...
			ed.onInit.add(function(ed) {
				...
				if ( ed.id != 'trm_mce_fullscreen' )
					ed.dom.addClass(ed.getBody(), 'trm-editor');
