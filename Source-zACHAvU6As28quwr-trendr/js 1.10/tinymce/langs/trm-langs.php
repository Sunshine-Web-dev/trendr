...
tinyMCE.addI18n("' . $language . '.trendr",{
trm_adv_desc:"' . mce_escape( __('Show/Hide Kitchen Sink') )  . ' (Alt+Shift+Z)",
trm_more_desc:"' . mce_escape( __('Insert More Tag') ) . ' (Alt+Shift+T)",
trm_page_desc:"' . mce_escape( __('Insert Page break') ) . ' (Alt+Shift+P)",
trm_help_desc:"' . mce_escape( __('Help') ) . ' (Alt+Shift+H)",
trm_more_alt:"' . mce_escape( __('More...') ) . '",
trm_page_alt:"' . mce_escape( __('Next page...') ) . '",
...
tinyMCE.addI18n("' . $language . '.trmeditimage",{
