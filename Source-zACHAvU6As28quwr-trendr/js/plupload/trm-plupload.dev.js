...
(function( exports, $ ) {
	...
	if ( typeof _trmPluploadSettings === 'undefined' )
		return;

	/*
	 * An object that helps create a trendr uploader using plupload.
	 *
	...
	Uploader = function( options ) {
		...
		for ( key in elements ) {
			...
			if ( ! this[ key ].prop('id') )
				this[ key ].prop( 'id', '__trm-uploader-id-' + Uploader.uuid++ );
		...
		(function( dropzone, supported ) {
			...
			if ( ! supported )
				return dropzone.unbind('.trm-uploader');

			// 'dragenter' doesn't fire correctly,
			// simulate it with a limited 'dragover'
			dropzone.bind( 'dragover.trm-uploader', function(){
				if ( active )
					return;
			...
			dropzone.bind('dragleave.trm-uploader, drop.trm-uploader', function(){
				active = false;
	...
	$.extend( Uploader, _trmPluploadSettings );
