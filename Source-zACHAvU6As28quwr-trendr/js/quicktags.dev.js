 ...
 * Quicktags
 *
 * This is the HTML editor in trendr. It can be attached to any textarea and will
...
(function(){
	 ...
	 * use add_action( 'admin_print_footer_scripts', 'output_my_js', 100 ) or add_action( 'trm_footer', 'output_my_js', 100 )
	 *
	...
	qt.insertContent = function(content) {
		var sel, startPos, endPos, scrollTop, text, canvas = document.getElementById(trmActiveEditor);
