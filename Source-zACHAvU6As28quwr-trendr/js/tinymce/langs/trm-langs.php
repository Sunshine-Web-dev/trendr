...
function trm_mce_translation() {
	...
	$trendr = array(
		'trm_adv_desc' => __('Show/Hide Kitchen Sink (Alt + Shift + Z)'),
		'trm_more_desc' => __('Insert More Tag (Alt + Shift + T)'),
		'trm_page_desc' => __('Insert Page break (Alt + Shift + P)'),
		'trm_help_desc' => __('Help (Alt + Shift + H)'),
		'trm_more_alt' => __('More...'),
		'trm_page_alt' => __('Next page...'),
	...
	$locale = _TRM_Editors::$mce_locale;
	...
	$translated .= 'tinyMCE.addI18n("' . $locale . '.trendr", ' . json_encode( $trendr ) . ");\n";
	$translated .= 'tinyMCE.addI18n("' . $locale . '.trmeditimage", ' . json_encode( $trmeditimage ) . ');';

	return $translated;
}

$lang = trm_mce_translation();
